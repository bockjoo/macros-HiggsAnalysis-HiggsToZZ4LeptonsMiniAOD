...
f4mu_TTV = f4mu.Get("nEvent_4l_w_TTV")
f4e_TTV = f4e.Get("nEvent_4l_w_TTV")
f2e2mu_TTV = f2e2mu.Get("nEvent_4l_w_TTV")

f4mu_VVV = f4mu.Get("nEvent_4l_w_VVV")
f4e_VVV = f4e.Get("nEvent_4l_w_VVV")
f2e2mu_VVV = f2e2mu.Get("nEvent_4l_w_VVV")
...
#// Signal Z' baryonic 
f4mu_ZpBaryonic_MZp500_MChi1   = f4mu.Get("nEvent_4l_w_ZpBaryonic_MZp500_MChi1")
f4e_ZpBaryonic_MZp500_MChi1    = f4e.Get("nEvent_4l_w_ZpBaryonic_MZp500_MChi1")
f2e2mu_ZpBaryonic_MZp500_MChi1 = f2e2mu.Get("nEvent_4l_w_ZpBaryonic_MZp500_MChi1")
...
latexOUTFile = "plots/MonoHiggsTableWithErrors.tex" # cutflow_%s_%s.tex" % (whichchannel, self.whichenergy))
...
outformat = ( "$Z\\gamma*, ZZ$ & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f  & %.2f $\\pm$ %.2f \\\\ \n" % ( f4e_ZZ.GetBinContent(22), f4e_ZZ.GetBinError(22), f4mu_ZZ.GetBinContent(22), f4mu_ZZ.GetBinError(22), f2e2mu_ZZ.GetBinContent(22), f2e2mu_ZZ.GetBinError(22), f4e_ZZ.GetBinContent(22)+f4mu_ZZ.GetBinContent(22)+f2e2mu_ZZ.GetBinContent(22), sqrt(f4e_ZZ.GetBinError(22)*f4e_ZZ.GetBinError(22) + f4mu_ZZ.GetBinError(22)*f4mu_ZZ.GetBinError(22) + f2e2mu_ZZ.GetBinError(22)*f2e2mu_ZZ.GetBinError(22) ) ) ) 
latexOUTFD.write( outformat )

outformat = ( "$t \\bar{t} V$ & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f  & %.2f $\\pm$ %.2f \\\\ \n" % ( f4e_TTV.GetBinContent(22), f4e_TTV.GetBinError(22), f4mu_TTV.GetBinContent(22), f4mu_TTV.GetBinError(22), f2e2mu_TTV.GetBinContent(22), f2e2mu_TTV.GetBinError(22), f4e_TTV.GetBinContent(22)+f4mu_TTV.GetBinContent(22)+f2e2mu_TTV.GetBinContent(22), sqrt(f4e_TTV.GetBinError(22)*f4e_TTV.GetBinError(22) + f4mu_TTV.GetBinError(22)*f4mu_TTV.GetBinError(22) + f2e2mu_TTV.GetBinError(22)*f2e2mu_TTV.GetBinError(22) ) ) )
latexOUTFD.write( outformat )

outformat = ( "$VVV$ & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f  & %.2f $\\pm$ %.2f \\\\ \n" % ( f4e_VVV.GetBinContent(22), f4e_VVV.GetBinError(22), f4mu_VVV.GetBinContent(22), f4mu_VVV.GetBinError(22), f2e2mu_VVV.GetBinContent(22), f2e2mu_VVV.GetBinError(22), f4e_VVV.GetBinContent(22)+f4mu_VVV.GetBinContent(22)+f2e2mu_VVV.GetBinContent(22), sqrt(f4e_VVV.GetBinError(22)*f4e_VVV.GetBinError(22) + f4mu_VVV.GetBinError(22)*f4mu_VVV.GetBinError(22) + f2e2mu_VVV.GetBinError(22)*f2e2mu_VVV.GetBinError(22) ) ) )
latexOUTFD.write( outformat )

 
ZX_4e=3.2;    ZX_4e_err=ZX_4e*0.43
ZX_4mu=3.9;   ZX_4mu_err=ZX_4mu*0.36
ZX_2e2mu=10.7;ZX_2e2mu_err=ZX_2e2mu*0.40
...
outformat = ( "SM Higgs ($m_{H}=125$ GeV)) & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f  & %.2f $\\pm$ %.2f \\\\ \n" % ( f4e_totSM_H.GetBinContent(22), f4e_totSM_H.GetBinError(22), f4mu_totSM_H.GetBinContent(22), f4mu_totSM_H.GetBinError(22), f2e2mu_totSM_H.GetBinContent(22), f2e2mu_totSM_H.GetBinError(22), f4e_totSM_H.GetBinContent(22)+f4mu_totSM_H.GetBinContent(22)+f2e2mu_totSM_H.GetBinContent(22), sqrt(f4e_totSM_H.GetBinError(22)*f4e_totSM_H.GetBinError(22) + f4mu_totSM_H.GetBinError(22)*f4mu_totSM_H.GetBinError(22) + f2e2mu_totSM_H.GetBinError(22)*f2e2mu_totSM_H.GetBinError(22) ) ) )
latexOUTFD.write( outformat )
 
sumbkg_4e    = f4e_ZZ.GetBinContent(22)+ f4e_TTV.GetBinContent(22)+ f4e_VVV.GetBinContent(22)+ f4e_totSM_H.GetBinContent(22)+ ZX_4e

sumbkg_4e_err    = sqrt ( f4e_ZZ.GetBinError(22)*f4e_ZZ.GetBinError(22)   +    f4e_TTV.GetBinError(22)*f4e_TTV.GetBinError(22) +   f4e_VVV.GetBinError(22)*f4e_VVV.GetBinError(22) +    f4e_totSM_H.GetBinError(22)*f4e_totSM_H.GetBinError(22) +    ZX_4e_err*ZX_4e_err)
 
sumbkg_4mu    =   f4mu_ZZ.GetBinContent(22)+   f4mu_TTV.GetBinContent(22)+   f4mu_VVV.GetBinContent(22)+   f4mu_totSM_H.GetBinContent(22)+    ZX_4mu

sumbkg_4mu_err    = sqrt (    f4mu_ZZ.GetBinError(22)*f4mu_ZZ.GetBinError(22)   +   f4mu_TTV.GetBinError(22)*f4mu_TTV.GetBinError(22) +   f4mu_VVV.GetBinError(22)*f4mu_VVV.GetBinError(22) +   f4mu_totSM_H.GetBinError(22)*f4mu_totSM_H.GetBinError(22) +    ZX_4mu_err*ZX_4mu_err)

sumbkg_2e2mu    =    f2e2mu_ZZ.GetBinContent(22)+   f2e2mu_TTV.GetBinContent(22)+   f2e2mu_VVV.GetBinContent(22)+   f2e2mu_totSM_H.GetBinContent(22)+   ZX_2e2mu

sumbkg_2e2mu_err    = sqrt (    f2e2mu_ZZ.GetBinError(22)*f2e2mu_ZZ.GetBinError(22)   +   f2e2mu_TTV.GetBinError(22)*f2e2mu_TTV.GetBinError(22) +   f2e2mu_VVV.GetBinError(22)*f2e2mu_VVV.GetBinError(22) +   f2e2mu_totSM_H.GetBinError(22)*f2e2mu_totSM_H.GetBinError(22) +   ZX_2e2mu_err*ZX_2e2mu_err)

sumbkg_4l=sumbkg_4e+sumbkg_4mu+sumbkg_2e2mu
sumbkg_4l_err= sqrt (sumbkg_4e_err*sumbkg_4e_err+sumbkg_4mu_err*sumbkg_4mu_err+sumbkg_2e2mu_err*sumbkg_2e2mu_err)

latexOUTFD.write( "\\hline\n" )
outformat = ( "Sum of bkgs & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f  & %.2f $\\pm$ %.2f \\\\ \n" % ( sumbkg_4e,    sumbkg_4e_err, sumbkg_4mu,   sumbkg_4mu_err, sumbkg_2e2mu, sumbkg_2e2mu_err,  sumbkg_4l,sumbkg_4l_err ) )
latexOUTFD.write( outformat )

latexOUTFD.write( "\\hline\n" )
outformat = ( "Signal: ZpBaryonic ($m_{Z'}=500$ GeV, $m_\\chi=1$ GeV)  & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f & %.2f $\\pm$ %.2f  & %.2f $\\pm$ %.2f \\\\ \n" % ( f4e_ZpBaryonic_MZp500_MChi1.GetBinContent(22), f4e_ZpBaryonic_MZp500_MChi1.GetBinError(22), f4mu_ZpBaryonic_MZp500_MChi1.GetBinContent(22), f4mu_ZpBaryonic_MZp500_MChi1.GetBinError(22), f2e2mu_ZpBaryonic_MZp500_MChi1.GetBinContent(22), f2e2mu_ZpBaryonic_MZp500_MChi1.GetBinError(22), f4e_ZpBaryonic_MZp500_MChi1.GetBinContent(22)+f4mu_ZpBaryonic_MZp500_MChi1.GetBinContent(22)+f2e2mu_ZpBaryonic_MZp500_MChi1.GetBinContent(22), sqrt( f4e_ZpBaryonic_MZp500_MChi1.GetBinError(22)*f4e_ZpBaryonic_MZp500_MChi1.GetBinError(22)+ f4mu_ZpBaryonic_MZp500_MChi1.GetBinError(22)*f4mu_ZpBaryonic_MZp500_MChi1.GetBinError(22)+ f2e2mu_ZpBaryonic_MZp500_MChi1.GetBinError(22)*f2e2mu_ZpBaryonic_MZp500_MChi1.GetBinError(22) ) ) )
latexOUTFD.write( outformat )


latexOUTFD.write( "\\hline\n" )
outformat = ( "Observed & %d & %d & %d & %d \\\\ \n" % ( int(f4e_totaldata.GetBinContent(22)), int(f4mu_totaldata.GetBinContent(22)), int(f2e2mu_totaldata.GetBinContent(22)), int(f4e_totaldata.GetBinContent(22)+f4mu_totaldata.GetBinContent(22)+f2e2mu_totaldata.GetBinContent(22)) ) )
latexOUTFD.write( outformat )
 
latexOUTFD.write( "\\hline \\hline \n") 
latexOUTFD.write( "\\end{tabular}\n") 
latexOUTFD.write( "}\n") 
latexOUTFD.write( "\\caption{Number of expected background and signal events and number of observed candidates, after pplying the full mono-Higgs selection; only statistical errors are quoted.}\n") 
latexOUTFD.write( "\\label{tab:MonoHiggs_yields}\n")
